...
export const STR = {
  nl: {
    ...
    now: "nu",
    tab_gate: "Poort", tab_home: "Thuis", tab_notify: "Meldingen", tab_safety: "Veiligheid",
    unsaved: "Niet-bewaarde wijzigingen",
    flow_title: "Zo reageert je poort als ze niet beweegt", flow_pulse: "Puls", flow_watch: "{t} kijken",
    at_home: "Thuis", away: "Weg",
    notify_d: "Hier krijg je een bericht als de poort in storing gaat of niet kan sluiten.",
    notify_ha: "Enkel in Home Assistant", notify_ha_d: "In het meldingenpaneel van Home Assistant",
    test: "Test", test_sent: "Testmelding verstuurd", test_msg: "Testmelding van de Hekkenplanner. Werkt!",
    wh_none: "Nog geen signaal van de camera ontvangen", wh_last: "Laatste signaal {t}",
    howto: "Zo stel je het alarm in UniFi Protect in",
    howto_1: "Alarm Manager → nieuw alarm → Objects: Person en Vehicle (en Animal).",
    howto_2: "Scope: Include, en vink de zone van de poort aan.",
    howto_3: "Action: Webhook → Custom Webhook, plak dit adres bij Delivery URL.",
    howto_4: "Laat Ignore Repeated Actions uit en klik op Test Alarm.",
    search: "Zoeken…", show_all: "Toon alle bewegingssensoren", show_less: "Toon enkel camera-detectie",
  ...
  en: {
    ...
    now: "now",
    tab_gate: "Gate", tab_home: "Home", tab_notify: "Notifications", tab_safety: "Safety",
    unsaved: "Unsaved changes",
    flow_title: "How your gate reacts when it does not move", flow_pulse: "Pulse", flow_watch: "watch {t}",
    at_home: "Home", away: "Away",
    notify_d: "Where you get a message when the gate goes into fault or cannot close.",
    notify_ha: "Home Assistant only", notify_ha_d: "In the Home Assistant notification panel",
    test: "Test", test_sent: "Test notification sent", test_msg: "Test notification from the Hekkenplanner. It works!",
    wh_none: "No signal from the camera received yet", wh_last: "Last signal {t}",
    howto: "How to set up the alarm in UniFi Protect",
    howto_1: "Alarm Manager → new alarm → Objects: Person and Vehicle (and Animal).",
    howto_2: "Scope: Include, and tick the gate zone.",
    howto_3: "Action: Webhook → Custom Webhook, paste this address as Delivery URL.",
    howto_4: "Leave Ignore Repeated Actions off and click Test Alarm.",
    search: "Search…", show_all: "Show all motion sensors", show_less: "Show camera detection only",
...
export const ICON = {
  ...
  bell: "M12 22c1.1 0 2-.9 2-2h-4a2 2 0 002 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4a1.5 1.5 0 00-3 0v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z",
  ...
  phone: "M17 1H7a2 2 0 00-2 2v18a2 2 0 002 2h10a2 2 0 002-2V3a2 2 0 00-2-2zm0 18H7V5h10v14z",
